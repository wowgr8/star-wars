...
function Characters() {
  ...
  const { setSelectedPlanet, setCurrentView } = useContext(Context);
  ...
  return (
    <div className='grid place-items-center text-gray-50'>
      ...
      <h2>
        {listFull 
        ? <div className="text-green-400">All Characters Loaded!</div>  
        : <div className="text-sky-400">Searching the galaxies for all characters.. please hold.</div> 
        }
      </h2> 
